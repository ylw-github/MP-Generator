package cn.com.ylw.generator.utils;

import cn.com.ylw.generator.model.ColumnEntity;
import cn.com.ylw.generator.model.TableEntity;
...
//    templates.add(TEMPLATE_PATH + FILE_NAME_PAGE);
    ...
    public static void generatorCode(
        ...
        map.put("modelSwagger", config.getBoolean("modelSwagger"));
    ...
    public static String getFileName(
            String template, String className, String packageName, String moduleName) {
